...
st.markdown("### 🥗 Diet Plan Visualization")

# Create circular indicators like the screenshot
fig = go.Figure()
...
for i, nutrient in enumerate(diet_data.keys()):
    fig.add_trace(go.Indicator(
        ...
        number={'suffix': "%"},
        title={'text': nutrient + f"<br>{diet_data[nutrient]} g"},
        gauge={
            'axis': {'range': [0, 100]},
            'bar': {'color': "#ff6600"},
            'bgcolor': "#eeeeee",
...
calories = [2000, 2100, 1800, 2200, 1900, 2300, 2100]
